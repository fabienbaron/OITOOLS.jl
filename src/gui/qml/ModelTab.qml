...
Item {
    ...
    ColumnLayout {
        ...
        // ── the fit: observables, optimiser, uncertainty ─────────────────────
        Rectangle {
            Layout.fillWidth: true
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        text: root.running ? "Stop" : "Fit"
                        enabled: root.running || root.canRun
                        // wire: fit_model / fit_model_lsqfit / fit_model_ultranest on a worker
                        // thread, with the 7-element weights built from the boxes above
                    }
                }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Button { text: "Adopt";      implicitHeight: root.dp(20)
                                 enabled: fitModel.count > 0 }
                                 // wire: write x_opt back into model_dict, so the table shows
                                 // the fitted values and the model can be saved as one
                    }
                }
