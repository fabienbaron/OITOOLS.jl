...
#power law
function visibility_ldpow(param, v_r; maxk = 200)
...
f=k->(-1)^k*exp.(2k*log.(0.5*pi*theta*v_r).+(logabsgamma(param[2]/2+2)[1]-logabsgamma(param[2]/2+k+2)[1]-logabsgamma(k+1)[1]));
