...
ax[:tick_params](axis="x", which="major", length=10.0)
ax[:tick_params](axis="x", which="minor", length=5.0)
cbar = colorbar(ax=gca(), aspect=50, orientation="vertical", label=L"Reduced $\chi$^2 values")
