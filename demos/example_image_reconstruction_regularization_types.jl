...
text(3,5,"Starting Image",color="white",size="xx-large")
...
imdisp(recenter(x,mask=x.>maximum(x)/10),pixsize=pixsize,colormap="gist_earth");
text(3,5,"Positivity only",color="white",size="xx-large")
...
x = reconstruct(x_start, data, ft, regularizers = regularizers, verb = false, maxiter=500);
imdisp(recenter(x,mask=x.>maximum(x)/10),pixsize=pixsize,colormap="gist_earth");
text(3,5,"l1 hyperbolic approx",color="white",size="xx-large")
...
x = reconstruct(x_start, data, ft, regularizers = regularizers, verb = false, maxiter=500);
imdisp(recenter(x,mask=x.>maximum(x)/10),pixsize=pixsize,colormap="gist_earth");
text(3,5,"l1l2w - All data",color="white",size="xx-large")
...
imdisp(recenter(x,mask=x.>maximum(x)/10),pixsize=pixsize,colormap="gist_earth");
text(3,5,"l1l2w - V2 only",color="white",size="xx-large")
...
imdisp(recenter(x,mask=x.>maximum(x)/10),pixsize=pixsize,colormap="gist_earth");
text(3,5,"l1l2w - T3PHI + T3AMP",color="white",size="xx-large")
...
imdisp(recenter(x,mask=x.>maximum(x)/10),pixsize=pixsize,colormap="gist_earth");
text(3,5,"l1l2w - T3PHI only",color="white",size="xx-large")
