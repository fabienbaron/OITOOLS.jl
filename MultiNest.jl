# FB: drop in replacement for the official MultiNest package
# main change is that context is defined as a double/Float64 Array
module MultiNest
import Base: run
...
immutable Nested
    ...
    loglike::Function
    dumper::Function
    context::Vector{Cdouble}
end

# interface between MultiNest and Julia loglike function
function nested_loglike(cube_::Ptr{Cdouble}, ndim_::Ptr{Cint}, npar_::Ptr{Cint},lnew_::Ptr{Cdouble},nested_::Ptr{Void}
)
